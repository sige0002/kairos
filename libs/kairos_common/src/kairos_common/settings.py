...
class Settings(BaseSettings):
    ...
    # Optional browser-feedback TTS. This never gates recording. ``voicevox``
    # selects the opt-in local neural sidecar; the lightweight default remains
    # the bundled eSpeak fallback.
