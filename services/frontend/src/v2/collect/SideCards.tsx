...
export function BatchStatsCard({ machine }: { machine: BatchMachine }) {
  const { nRecorded, nGood, nReview, nFail } = machine.stats;
  return (
    <Card className="flex shrink-0 flex-col gap-1.5 p-[13px] px-[18px]">
      ...
      <div className="flex gap-3.5">
        <div className="flex flex-col">
          <span className="font-mono text-lg font-semibold text-gray-900">{nRecorded}</span>
          <span className="text-[11px] text-gray-400">recorded</span>
        </div>
        <div className="flex flex-col">
          <span className="font-mono text-lg font-semibold text-green-600">{nGood}</span>
          <span className="text-[11px] text-gray-400">good</span>
        </div>
        <div className="flex flex-col">
          <span className="font-mono text-lg font-semibold text-amber-600">{nReview}</span>
          <span className="text-[11px] text-gray-400">review</span>
        </div>
        <div className="flex flex-col">
          <span className="font-mono text-lg font-semibold text-red-600">{nFail}</span>
          <span className="text-[11px] text-gray-400">not usable</span>
        </div>
      </div>
    </Card>
  );
